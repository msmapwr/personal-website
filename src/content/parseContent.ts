...
function parseLocale(loc: Element): LocaleContent {
  ...
  const uiStrings: UiStrings = {
    ...
    pageNotFound: firstText(ui, "pageNotFound"),
    backHome: firstText(ui, "backHome"),
    noResults: firstText(ui, "noResults"),
    searchProjects: firstText(ui, "searchProjects"),
    clearFilters: firstText(ui, "clearFilters"),
    readMore: firstText(ui, "readMore"),
